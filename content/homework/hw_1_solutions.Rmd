...
We fail to reject the null hypothesis at level $\alpha = 0.15$, because the test statistic is equal to `r round(t.star, 2)`, which is inside of the acceptance region (`r round(int[1], 2)`, `r round(int[2], 2)`), and the p-value, which is $5.046509\times10^{-14}$ is much lower than $\alpha = 0.15$.
